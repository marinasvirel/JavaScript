...
function showCategory(category) {
    const catgoryProducts = products[category];
    let markupTopProductsDiv = "";
    catgoryProducts.forEach(function(product){
        markupTopProductsDiv += getProductMarkup(product);
    });
    productsEl.insertAdjacentHTML("afterbegin", markupTopProductsDiv);
}
